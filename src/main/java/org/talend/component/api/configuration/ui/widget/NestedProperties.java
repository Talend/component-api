...
@Ui
@Documentation("Mark a field as being represented by a nested properties widget - list of properties that can be "
        + "added or removed. Can be represented as a horizontal table widget in studio.")
@Retention(RUNTIME)
