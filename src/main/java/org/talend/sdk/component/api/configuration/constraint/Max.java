...
@Validation(expectedTypes = { Number.class, int.class, short.class, byte.class, long.class, double.class,
        float.class }, name = "max")
@Validation(expectedTypes = Collection.class, name = "maxItems")
@Validation(expectedTypes = CharSequence.class, name = "maxLength")
@Target({ FIELD, PARAMETER })
@Retention(RUNTIME)
@Documentation("Ensure the decorated option size is validated with a higher bound.")
